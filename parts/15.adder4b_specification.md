...
Description:
------------
The ADDER4B is a 4-bit bus version of the FULLADDER. It has therefore two 4-bit
input busses and one 4-bit output bus while the carry in and out bits are kept.
